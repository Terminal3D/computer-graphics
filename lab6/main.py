...
def initialize_lights():
    glLightfv(GL_LIGHT0, GL_POSITION, [-2.0, 0.0, 0.0, 1.0])
    ...
    glLightfv(GL_LIGHT1, GL_POSITION, [2.0, 0.0, 0.0, 1.0])
...
def display(window):
    global position_y, velocity_y, acceleration_y, use_texture, light0_enabled, light1_enabled, texture_id
...
def key_callback(window, key, scancode, action, mods):
    ...
    if action == glfw.PRESS or action == glfw.REPEAT:
        ...
        elif key == glfw.KEY_P:  # Corrected key for the second light
